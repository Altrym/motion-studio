...
2. Open `templates/<site>.md`
3. Use the design tokens and component specs when generating HTML
4. Preview the result in a local browser when visual verification is needed

Each template includes an **Implementation Notes** block at the top with:
- CDN font substitute and Google Fonts `<link>` tag (ready to paste)
- CSS font-family stacks for primary and monospace
- Reminders for HTML creation and visual verification
...
<head>
  ...
  <!-- Paste the Google Fonts <link> from the template notes -->
...
Create the HTML/CSS directly in the workspace, preview it with a simple local server when needed,
and verify the result visually in a browser.
