...
> ```
> Create the HTML directly in the workspace and use any simple local server when preview is needed.
> Verify visual accuracy with a browser preview or screenshot pass after generating.
