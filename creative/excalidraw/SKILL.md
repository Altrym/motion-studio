...
3. **Save the file** as a `.excalidraw` document in the workspace
4. **Optionally upload** for a shareable link using `scripts/upload.py`

### Saving a Diagram

Wrap your elements array in the standard `.excalidraw` envelope and save it to disk:

```json
{
  "type": "excalidraw",
  "version": 2,
  "source": "animate-skill",
...
```bash
python excalidraw/scripts/upload.py ~/diagrams/my_diagram.excalidraw
```
